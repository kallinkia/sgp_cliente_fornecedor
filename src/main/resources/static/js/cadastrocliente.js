const API_BUSCAR_TODOS = "http://localhost:8011/Clientes/listarTodos";
const API_SALVAR = "http://localhost:8011/Clientes/salvar";
const API_BUSCAR_POR_ID = "http://localhost:8011/Clientes/listarId";
const API_ATUALIZAR = "http://localhost:8011/Clientes/atualizar";
const API_DELETAR = "http://localhost:8011/Clientes/deletar";
const API_BUSCAR_NOME = "http://localhost:8011/Clientes/listarNome";
const API_BUSCAR_CPF = "http://localhost:8011/Clientes/listarCpf";
const API_BUSCAR_CNPJ = "http://localhost:8011/Clientes/listarCnpj";
...
async function salvar() {
    ...
    const cliente = {
        ...
        nome_razaoSocial:document.getElementById("nomeRazaoSocial").value,
...
async function editar(id) {
    ...
    document.getElementById("nomeRazaoSocial").value =cliente.nome_razaoSocial;
