...
function avaliar(star, nota, tipo) {
...
async function listarFornecedor() {
        ...
        avaliacoes.forEach(avaliacao => {
			...
			const media = (avaliacao.qualidadeDasPecas + avaliacao.prazoDeEntrega + avaliacao.atendimento + avaliacao.preco ) / 4;
			
			
            tr.innerHTML = `
                <td>${avaliacao.fornecedor.razaoSocial}</td>
                <td>${avaliacao.fornecedor.status}</td>
...
option.textContent = item.razaoSocial;
